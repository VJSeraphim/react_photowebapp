    ...
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-row flex-col justify-center bg-white items-center lg:p-5 p-3 lg:w-4/5 w-full">
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          />
          {user && (
            <div className="flex gap-2 my-2 items-cetner bg-white rounded-lg">
              <img 
                src={user.image}
          ...
          <input 
            ...
            placeholder="What are your thinkings for this image?"
          ...
          <input 
            ...
            placeholder="Add your destination link here."
            className="outline-none text-base sm:text-lg border-b-2 border-gray-200 p-2"
          />
          <div className="flex flex-col">
            ...
            <div className="flex justify-ent items-end mt-5">
              <button
                type="button"
                onClick={savePin}
